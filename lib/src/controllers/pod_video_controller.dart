...
// Set volume between 0.0 - 1.0,
  ...
  void togglePlayPauseVideo() {
    logger
      ..i('_ctr.videoPosition ${_videoCtr!.value.position}') //0:27:11.541000
      // ..i('_ctr.videoPosition1 ${_videoCtr!.value.aspectRatio}')
      // ..i('DurationRange : ${_videoCtr!.value.buffered}')
      // ..i('captionOffset : ${_videoCtr!.value.captionOffset}')
      ..i('duration :  ${_videoCtr!.value.duration}');
