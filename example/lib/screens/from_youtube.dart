  ...
  void initState() {
    controller = PodPlayerController(
      playVideoFrom: PlayVideoFrom.youtube(
          'https://youtu.be/RNlRNeoOKWo'), //https://www.youtube.com/watch?v=RNlRNeoOKWo  A3ltMaM6noM
    ...
    controller.videoSeekTo(
        const Duration(minutes: 27, seconds: 11, milliseconds: 541000));
    super.initState();
  }
        ...
        Expanded(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'https://youtu.be/RNlRNeoOKWo',
          ...
          child: ElevatedButton(
            onPressed: () async {
              ...
              try {
                ...
                if (!mounted) return;
                logger.i(controller.currentVideoPosition);
